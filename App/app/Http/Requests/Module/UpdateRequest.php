...
class UpdateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            'key' => [
                'required', 'string', 'alpha_num', 'max:255', Rule::unique(Module::class)->ignore($this->route('module'))
            ],
            'name' => [
            ...
            'route' => [
                'required_if:type,' . ModuleType::INDIVIDUAL, 'max:255', Rule::unique(Module::class)->ignore($this->route('module'))
            ],
            'child_route' => [
